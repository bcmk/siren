...
Вы подписываетесь на любимых стримеров командой **/add**.
...
- Kick: [t.me/KickSirenBot](https://t.me/KickSirenBot)
...
- **add** _КАНАЛ_ — Добавить канал
- **remove** _КАНАЛ_ — Удалить канал
- **remove_all** — Удалить все каналы
- **list** — Список подписок
- **buy_subs** — Купить дополнительные подписки за звёзды Telegram
- **pics** — Кадры трансляций в этот момент
- **week** _КАНАЛ_ — График канала в предыдущие 7 дней
- **month** _КАНАЛ_ — Дни трансляций в предыдущие 5 недель
- **help** — Список команд
- **settings** — Настройки
- **feedback** _ВАШЕ_СООБЩЕНИЕ_ — Обратная связь

Подставьте вместо **_КАНАЛ_** реальный идентификатор канала или модели.
...
[Технический блог](https://medium.com/@siren.chat)
