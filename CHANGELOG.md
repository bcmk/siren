...
- Convert status_changes by streamer over the existing index, so a fragmented heap converts correctly
...
- Stripchat per-model status checks moved to the broadcasts API
