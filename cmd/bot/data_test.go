...
var testTranslations = cmdlib.Translations{
	...
	TimezoneButton:  &cmdlib.Translation{Key: "timezone_button", Str: "TimezoneButton", Parse: cmdlib.ParseRaw},
	TimezoneAppHeader: &cmdlib.Translation{
		Key: "timezone_app_header", Str: "TimezoneAppHeader", Parse: cmdlib.ParseRaw},
	TimezoneAppCurrent: &cmdlib.Translation{
		Key: "timezone_app_current", Str: "TimezoneAppCurrent", Parse: cmdlib.ParseRaw},
	TimezoneAppDetected: &cmdlib.Translation{
		Key: "timezone_app_detected", Str: "TimezoneAppDetected", Parse: cmdlib.ParseRaw},
	TimezoneAppPlaceholder: &cmdlib.Translation{
		Key: "timezone_app_placeholder", Str: "TimezoneAppPlaceholder", Parse: cmdlib.ParseRaw},
	TimezoneAppNoResults: &cmdlib.Translation{
	...
	Month:           &cmdlib.Translation{Key: "month", Str: "Month", Parse: cmdlib.ParseRaw},
